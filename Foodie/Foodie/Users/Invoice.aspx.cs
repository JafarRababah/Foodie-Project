...
namespace Foodie.Users
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        DataTable GetOrderDetails()
        {
            ...
            cmd.Parameters.AddWithValue("@PaymentID", Convert.ToInt32(Request.QueryString["PaymentID"]));
        ...
        protected void lbDownloadInvoice_Click(object sender, EventArgs e)
        {
            try
            {
                string downloadPath = @"C:\Users\Jafar\Desktop\Foodie_feane-1.0.0\order_invoice.pdf";
                DataTable tbl = GetOrderDetails();
                ExportToPdf(tbl, downloadPath, "Order Invoice");
