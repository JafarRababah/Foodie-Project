                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lbEdit" runat="server" CssClass="badge badge-primary"
                                                                        CommandArgument='<%# Eval("OrderDetailsID") %>' CommandName="edit" CausesValidation="true">
                                                                        <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
                                                ...
                                                <div>
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvOrderStatus" runat="server" ErrorMessage="Required" ForeColor="red"
                                                                SetFocusOnError="true" Display="Dynamic" InitialValue="0" ControlToValidate="ddlOrderStatus"></asp:RequiredFieldValidator>
